...
class Sage < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/chasey-myagi/sage/releases/download/v0.1.0/sage-v0.1.0-darwin-arm64.tar.gz"
      sha256 "3f40230fc41cd1be9f289e52d2d26339a4f9bb517f29ed0423173acf136f3f30"
    end
    on_intel do
      url "https://github.com/chasey-myagi/sage/releases/download/v0.1.0/sage-v0.1.0-darwin-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/chasey-myagi/sage/releases/download/v0.1.0/sage-v0.1.0-linux-arm64.tar.gz"
      sha256 "e4f55ee868cbdf77db671ef3c68afd167e6fa0264db23e9515baaf7235f0e0e8"
    end
    on_intel do
      url "https://github.com/chasey-myagi/sage/releases/download/v0.1.0/sage-v0.1.0-linux-x86_64.tar.gz"
